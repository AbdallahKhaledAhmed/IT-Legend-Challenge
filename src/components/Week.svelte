...
<div class="collapse collapse-plus bg-base-100 border-base-300 rounded sm:rounded-none border sm:py-7 sm:px-2 my-5">
  ...
  <div class="collapse-content sm:bg-none sm:border-0 flex flex-col gap-5 ">
